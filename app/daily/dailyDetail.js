    ...
    render() {
        return (
            <View style={[com.flex,com.bce6]}>
                ...
                <ScrollView style={[com.flex,com.bgce6]}>
                    <View style={[com.row,com.jcsb,com.mgt10,com.pdt5l15,com.bgcfff]}>
                        <View>
                            <View style={[com.row,]}>
                    ...
                    <View style={[com.pdt5l15,com.btbwc]}>
                        <Text style={[com.fs12,com.cbe]}>工作进展</Text>
                    </View>
                    <View style={[com.bgcfff,com.pd15,com.bbwcc,]}>
                        <Text style={[com.cbe]}>暂无工作进展</Text>
                    </View>

                    <View style={[com.btbwc,com.mgt5]}>
                        <View style={[com.row,com.jcsb,com.pdt10l15,com.bgcfff,com.bbwc]}>
                            <Text style={[com.cab,com.fs12]}>共评论(0)</Text>
                            <Image
                    ...
                    <View style={[com.bgcfff,com.mgt5,]}>
                        ...
                        <View style={[com.row,com.pdt10l15]}>
                            <View style={[com.mgr5]}>
                                <Text>07-10</Text>
                                <Text>09:01</Text>
                            </View>
                            <Text
                                style={[com.h3,com.mgt10,com.mgr10,com.mgl10,com.br200,{borderWidth:3,borderColor:'blue'}]}></Text>
                            <View>
                                <Text>尼大叶</Text>
                ...
                <TouchableHighlight
                    ...
                    underlayColor="#fff"
                    >
                    <View style={[com.aic,com.bgcfff,com.pd10,com.btwd]}>
