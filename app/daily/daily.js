...
import DailyMy from './index/dailyMy';
import DailySubordinate from './index/dailySubordinate';
import DailyListMy from './index/dailyListMy';
import DailyListSubordinate from './index/dailyListSubordinate';
export default class Log extends Component {
    ...
    //动态信息获取 查看 我的客户
    _getContent() {
        if(this.state.tab==1 && this.state.change==true){//我的日程列表
            return <DailyMy navigation={this.props.navigation}/>
        }else if(this.state.tab==2 && this.state.change==true){//下属日程列表
            return <DailySubordinate navigation={this.props.navigation}/>
        }else if(this.state.tab==1 && this.state.change==false){//搜索我的日程
            return <DailyListMy navigation={this.props.navigation}/>
        }else if(this.state.tab==2 && this.state.change==false){//搜索下属日程
            return <DailyListSubordinate navigation={this.props.navigation}/>
        }
    }
