    ...
    return (
      ...
      <View style={styles.ancestorCon}>
        ...
        <View style={[styles.navCon,com.aic]}>
          ...
          <Text style={[styles.fSelf,com.fl30]}>人力日报</Text>
          <TouchableHighlight
            style={[]}
        ...
        <ScrollView style={[]}>
          <View style={[com.mixbbp515]}>
            <Text style={[com.fs10,com.cbe]}>人力日报</Text>
          </View>
          <View style={[com.pdl15,com.bgcfff]}>
            <View style={[com.bgcfff,com.bbwd]}>
              <View>
                <View style={[com.row,com.aic]}>
                  <Text style={[com.w70]}>简历数</Text>
                  <TextInput
